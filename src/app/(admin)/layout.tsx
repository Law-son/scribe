...
const COMPLETION_FIELDS =
  "gender dateOfBirth whatsapp email isStudent programmeOfStudy level departmentInChurch emergencyContactName emergencyContactPhone emergencyContactRelationship";
